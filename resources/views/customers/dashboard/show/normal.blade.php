    ...
    <div class="d-flex flex-column flex-column-fluid">
        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                @endif
                                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">{{$item->category->title}}</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                            ...
                            <div class="card-body text-center pt-0">
                                ...
                                <div id="bannersCarousel" class="carousel slide mt-4" data-ride="carousel">
                                    <div class="carousel-inner">
                                        @foreach($item->images as $index => $banner)
                                            <div class="carousel-item {{ $index === 0 ? 'active' : '' }}">
                                                <img src="{{ asset('storage/'.$banner->image_path) }}" class="d-block w-100" alt="Banner Image" style="height: 400px; object-fit: contain;">
                                            </div>
                                        @endforeach
                                    </div>
