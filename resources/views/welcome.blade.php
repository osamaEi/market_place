...
@include('admin.body.header')
    ...
    <div class="text-center mb-11">
        ...
        <!--end::Title-->
        <!--begin::Subtitle-->
        <div class="text-gray-500 fw-semibold fs-6">ً{{__('welcome back')}} !</div>
        <!--end::Subtitle-->
    </div>
    <!--begin::Heading-->
    ...
    <div class="fv-row mb-8">
        <!--begin::Email-->
        <input type="email" placeholder="{{__('Email')}}" name="email" id="email" :value="old('email')" required autofocus autocomplete="username" class="form-control bg-transparent" />
        <!--end::Email-->
    ...
    <div class="fv-row mb-8">
        <!--begin::Password-->
        <input type="password" placeholder="{{__('Password')}}" name="password" id="password" required autocomplete="current-password" class="form-control bg-transparent" />
        <!--end::Password-->
