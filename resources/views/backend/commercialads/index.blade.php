                            ...
                            <tbody>
                                @foreach($commercialAds as $ad)
                                    <tr>
                                        ...
                                        <td><a href="{{route('commercialads.show',$ad->id)}}" >
                                            {{ __('Show') }}
                                        </a>
                                    </td>
                                    <td>   <span class="views-container">
                                        {{$ad->views_count}}
                                    </span></td>
                                    <td>
                                        <!-- Actions Dropdown -->
                                        <div class="dropdown">
                                            <button class="btn btn-sm btn-secondary dropdown-toggle" type="button" id="actionsDropdown-{{ $ad->id }}" data-bs-toggle="dropdown" aria-expanded="false">
                                                {{ __('Actions') }}
                                            </button>
                                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="actionsDropdown-{{ $ad->id }}">
                                                <!-- Edit Action -->
                                                <li>
