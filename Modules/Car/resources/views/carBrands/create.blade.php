        ...
        $('#create-feature-form').on('submit', function(e) {
            ...
            $.ajax({ 
                ...
                success: function(response) {
                    ...
                    $('#form-response').html('<div class="alert alert-success">{{__('Brand created succssfulely')}}</div>');
                },
                error: function(xhr) {
    let errors = xhr.responseJSON.errors;
    let message = '{{__("Brand already exists")}}'; // Add your custom message here
    
    let errorHtml = '<div class="alert alert-danger">';
    errorHtml += '<p class="mb-2"><strong>' + message + '</strong></p>';
    if (errors) {
        errorHtml += '<ul>';
